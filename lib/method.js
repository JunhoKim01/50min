// import communityScraper from '../lib/communityScraper/communityScraper-0.4.1';
import { Status } from '../imports/api/Admin/Status.js';
import { ScrapJPG, ScrapGIF, ScrapAVI, Picks } from '../imports/api/Contents/Scraps.js';
...
Meteor.methods({
  ...
  updateSnapshot(options, resultArr) {
    ...
    if (currentSnapshot === undefined) {
      console.log('No currentSnapshot. It will be generated automatically.');
     // Create new snapshot
